...
define wil = Character('Will Yin', color="#ff0000", image="yin")
define wiy = Character('Will Yang', color="#FFFFFF", image="will")
...
define ale = Character('Le Calculetor', color="#FFFFFF", image="le")
