label garyreeducation:
    ...
    $ quest.unlock_quest("garythirst1")
...
label garyreeducation1:
    ...
    $ sze.thirst += 1
    $ quest.complete_quest("garythirst1")
...
label garyreeducation2:
    ...
    $ sze.thirst += 2
    $ quest.complete_quest("garythirst2")
...
label garyreeducation3:
    ...
    $ sze.thirst += 3
    $ quest.complete_quest("garythirst3")
...
label garyreeducation4:
    ...
    $ sze.thirst += 4
    $ quest.complete_quest("garythirst4")
...
label garyreeducation5:
    ...
    $ sze.thirst += 5
    $ quest.complete_quest("garythirst5") 
...
label garyreeducation6:
    ...
    $ sze.thirst += 6
    $ quest.complete_quest("garythirst6")
...
label garyreeducation7:
    ...
    $ sze.thirst += 7
    $ quest.complete_quest("garythirst7")
...
label garyreeducation8:
    ...
    $ sze.thirst += 8
    $ quest.complete_quest("garythirst8")
